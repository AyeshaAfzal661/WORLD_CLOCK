...
public class Clock_DB_DAO implements Interface_ClockDAO {
    private Context context;

    public Clock_DB_DAO(Context ctx){
        context = ctx;
    }
    ...
    public void save(Hashtable<String,String> attributes)
    {
        ...
        db.insert("Selected_clocks",null,content);
    }
    ...
    public ArrayList<Hashtable<String,String>> load()
    {
        ...
        String query = "SELECT * FROM Selected_clocks";
